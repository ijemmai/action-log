...
/** Request to get the games drawer badge status for a specific app by slug */
export type GetGamesDrawerBadgeStatusForAppsRequest = {
    /** The slugs of the apps to inspect (e.g., ["pixelary", "hot-and-cold"]) */
    appSlugs: string[];
};
/** Response from getting the status of an active games drawer badge for an app */
export type GetGamesDrawerBadgeStatusForAppsResponse = {
    /** Map of app slug to badge status */
    statuses: {
        [key: string]: GetGamesDrawerBadgeStatusResponse;
    };
};
export type GetGamesDrawerBadgeStatusForAppsResponse_StatusesEntry = {
    key: string;
