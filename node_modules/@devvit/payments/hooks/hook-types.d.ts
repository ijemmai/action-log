...
/** @internal */
export declare function orderStatusProtoToHook(orderResultStatus: OrderResultStatusProto): OrderResultStatus;
...
export type AsyncHookResult<T extends Record<string, unknown>> = Simplify<T & (SuccessAsyncState | ErrorAsyncState | LoadingAsyncState)>;
